...
import org.springframework.stereotype.Component; // ✅ THÊM
...
public class AuthTokenFilter extends OncePerRequestFilter {
    ...
    @Autowired
    private MockAuthService mockAuthService; // ✅ DÙNG MOCK SERVICE
        ...
        try {
            ...
            if (jwt != null) {
                ...
                logger.info("Authenticated user: {} with roles: {}",
                        userDetails.getUserId(), userDetails.getAuthorities());
            }
        } catch (Exception e) {
