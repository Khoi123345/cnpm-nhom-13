    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <Card className="p-8">
          ...
          <Button className="mt-4" onClick={() => router.push('/restaurant/dashboard')}>
            Back to Dashboard
          </Button>
        </Card>
      </div>
  ...
  return (
    <div className="min-h-screen bg-background p-4 md:p-8">
      <header className="max-w-6xl mx-auto mb-8">
        <Link href="/restaurant/dashboard" className="text-primary hover:underline">
        ...
        {showDroneTracking && (
          <Card>
            <CardHeader>
              ...
              <p className="text-sm text-muted-foreground">Real-time delivery progress</p>
            </CardHeader>
            <CardContent>
              <DroneTrackingMap
